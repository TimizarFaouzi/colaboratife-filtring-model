...
@else
            ...
            <input type="hidden" id="sra" name="sra"value="{{Auth::user()->rsa}}">
            
            <input type="hidden" id="srb" name="srb"value="{{Auth::user()->rsb}}">
        
            <input type="hidden" id="user_id" name="user_id"value="{{Auth::user()->id}}">
            
            <input type="hidden" id="nb_vsited" name="user_id"value="{{Auth::user()->id}}">
     ...
     <!-- Top Bar Start -->
                  ...
                  <nav class="navbar-custom">
                      <ul class="navbar-right list-inline float-right mb-0">
                          ...
                          <li class="dropdown notification-list list-inline-item">
                              <a class="VI-FORM nav-link dropdown-toggle arrow-none waves-effect " data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false" value="dd">
                                  <i class="mdi mdi-bell-outline noti-icon"></i>
                                  <span class="badge badge-pill badge-danger noti-icon-badge"></span>
                              </a>
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg dropdown-menu-noti px-1">
                                  <!-- item-->
                                  ...
                                  <div class="slimscroll notification-item-list"></div>--}}
                                  <div class="slimscroll notification-item-list" style="min-height: 10cm">
                          ...
                          <ul class="metismenu" id="side-menu">
                              ...
                              <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a class="get-locationCity" href="#"> Locations City</a></li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a class="table-Historique-Totale" href="#">Table Historical</a></li>
                              ...
                              <li>
                                  ...
                                  <ul class="submenu">
                                      ...
                                      <li><a  class="SystemRocomndation" href="#">Home</a></li>
                                      <li><a class="prfile_parsonal" href="#">Profile personal</a></li>
                              ...
                              <li>
                                  ...
                                  <ul class="submenu">
                                     ...
                                     <li>
                                        <a class="predaction-item-base-SlopOne" href="#"><i class="bi bi-star-half"></i>  Predaction base slope one</a>
                                    </li> 
                                        <li>
                                            <a class="MatrixFactorisation" href="#"><i class="bi bi-star-half"></i>  Matrix Factorisation</a></li>
                              ...
                              <li>
                                  ...
                                  <ul class="submenu">
                                      <li><a href="#" class="Dashboard">Chart Rocomndation System</a></li>
                                      <li><a href="#" class="Dashboard">Chart POI</a></li>
                                  </ul>
                              </li>
                                <li>
          ...
          {{--add wilaya--}}   
                ...
                <script src="{{asset('page/notification.js')}}"></script>
                
                {{-- script insertion location to table wilaya et commens<script src="{{asset('page/notification.js')}}"></script>
...
setInterval(function () {
        $.ajax({
            type: "GET",
            url: "/Show_Notification"+$('#user_id').val(),
            dataType: "json",
            success: function (response) {
                if (!response.number==0) {

                }
                    response.tablenotification.forEach((val,index)=>{
                        //document.wirte("Ccc")
                             if (!val.vi_form==1) {
